...
### A note about maven
I was really never much of a maven worshiper, if I may say so. I use it because it's so widespread and it does its job (in the end) that I simply could not afford to ignore it. But there are better tools out there. E.g. a great ruby tool for Java development automation called [Apache Buildr](http://buildr.apache.org/) that's much simpler and easier to use. Unfortunately, we'll have to postpone covering it until it gains more traction in the community. If you want to indulge yourself in more maven's *suckassness*, take a look at [the spymemcached author's great blog post](http://dustin.github.io/2010/04/01/why-not-maven.html). Or [grails author's post](http://graemerocher.blogspot.com/2008/01/why-grails-doesnt-use-maven.html). If not, move on, your loss.
