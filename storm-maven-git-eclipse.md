...
* `artifactId`? That's the name of your project. Of course they couldn't name it "projectId", what's wrong with you? If fact, artefact is like a maven general object (e.g. project, module, dependency, plugin). I'll use `my-little-storm`.
